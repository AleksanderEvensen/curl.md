...
:::tip
Optionally, [authenticate](#authentication) with the [`curl_md_login`](#commands) command to unlock higher usage limits and features, like [objective extraction](/docs/guide/features#objective-based-narrowing).
:::
::::
...
You can also tell OpenCode to use a specific [objective](/docs/guide/api#objective), [keywords](/docs/guide/api#keywords), or let it decide what to use on its own (it’s really good at this).
