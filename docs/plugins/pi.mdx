...
You can also tell Pi to use a specific [objective](/docs/guide/api#objective), [keywords](/docs/guide/api#keywords), or let it decide what to use on its own (it’s really good at this).
