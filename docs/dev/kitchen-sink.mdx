---
title: Kitchen Sink
description: Preview the Markdown components and styles supported by curl.md docs.
---
...
Inline syntax highlighting works too: `pnpm dev{:sh}` or `console.log("curl.md"){:ts}`.
