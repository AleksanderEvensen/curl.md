/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 463bd0bb1de4572f86712860598d1ced)
// Runtime types generated with workerd@1.20260212.0 2026-02-12 no_handle_cross_request_promise_resolution,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./entry-server");
	}
